...
using SimplCommerce.Module.Comments.Endpoints;
using SimplCommerce.Module.Contacts.Endpoints;
...
using SimplCommerce.Module.ShippingTableRate.Endpoints;
...
app.MapShippingTableRateAdminEndpoints();
